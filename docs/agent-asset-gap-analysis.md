...
更新：2026-09-22。本文件對應整合版 **1.4.1**，區分已實作操作與仍待完成的工作。
版本沿用 **1.4.x**；正式發布狀態以 GitHub Releases 為準。
...
以下依 1.4.1 的原生契約、實作與回歸測試整理；較舊安裝版本可能沒有這些操作。
執行時應讀取完整 contract／schema 與 enabled flags。

| 格式／工作流 | 1.4.1 已有能力 | 明確限制或後續工作 |
|---|---|---|
...
這項整合納入 1.4.1；SDK2 自動化測試與預設 Codex 的真實上游表單評估
...
1. 延伸 ODS 工作表與列欄 CRUD、PDF 內文操作與更廣的欄位覆蓋及其他格式的原生工作流，
