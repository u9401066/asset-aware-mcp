...
```bash
codex mcp add asset-aware-mcp -- uv tool run --python 3.11 --from asset-aware-mcp==2.0.0 asset-aware-mcp
```
...
`2.0.0` 的 active packaged PDF extras 只有 `[pdf-plus]`（PyMuPDF4LLM）與
