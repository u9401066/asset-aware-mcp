...
- Codex 實測掃描 PDF → 表格 CRUD／引用／Excel；旋轉裁切有像素回歸，詳見 [Release And Testing](Release-And-Testing)。
...
| 匯出 agent assets | [PDF Document Workflow](PDF-Document-Workflow) | [LLM Wiki Knowledge Base](LLM-Wiki-Knowledge-Base) |
| 找章節與定位 | [Document Sections And Navigation](Document-Sections-And-Navigation) | [Citation Provenance](Citation-Provenance) |
