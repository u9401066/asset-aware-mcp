window.ASSET_AWARE_DOC_PAGES = [
  {
    ...
    "audience": "start",
    "title": "Overview",
    "blurb": "Project positioning, endpoint inventory, and documentation map.",
  ...
  },
  {
    ...
    "blurb": "Install, configure, and verify the MCP server quickly.",
    "file": "site-content/getting-started.md",
    "titleByLang": {
      "zh": "開始使用"
    },
    "blurbByLang": {
      "zh": "快速安裝、設定並驗證 MCP server。"
    }
  },
  {
    "slug": "design-ux",
    ...
    "lang": "all",
    "audience": "start",
    "title": "Design And UX Notes",
    "blurb": "Human-facing information architecture, layout, and completeness rules.",
    "file": "site-content/design-ux.md",
    "titleByLang": {
      "zh": "設計與 UX 說明"
    },
    "blurbByLang": {
      "zh": "面向人類閱讀的資訊架構、版面與完整性規則。"
    }
  },
  {
    "slug": "architecture",
    ...
    "audience": "developer",
    "title": "Architecture",
    "blurb": "DDD layers, runtime surfaces, and data flow.",
    "file": "site-content/architecture.md",
    "titleByLang": {
      "zh": "架構"
    },
    "blurbByLang": {
      "zh": "DDD 分層、runtime surface 與資料流。"
    }
  },
  {
    "slug": "mcp-tools",
    ...
    "audience": "reference",
    "title": "MCP Tools",
    "blurb": "Complete 59-tool public MCP surface by module.",
    "file": "site-content/mcp-tools.md",
    "titleByLang": {
      "zh": "MCP 工具"
    },
    "blurbByLang": {
      "zh": "依 module 整理的完整 59-tool MCP surface。"
    }
  },
  {
    "slug": "mcp-resources",
    ...
    "audience": "reference",
    "title": "MCP Resources",
    "blurb": "Document and table resource URI contracts.",
    "file": "site-content/mcp-resources.md",
    "titleByLang": {
      "zh": "MCP Resources"
    },
    "blurbByLang": {
      "zh": "Document 與 table resource URI contract。"
    }
  },
  {
    "slug": "pdf-workflow",
    ...
    "lang": "all",
    "audience": "user",
    "title": "PDF Document Workflow",
    "blurb": "PDF ingest, OCR, layout, segmentation, and assets.",
    "file": "site-content/pdf-workflow.md",
    "titleByLang": {
      "zh": "PDF 文件工作流"
    },
    "blurbByLang": {
      "zh": "PDF ingest、OCR、layout、segmentation 與 assets。"
    }
  },
  {
    "slug": "docx-dfm-workflow",
    "group": "docx-dfm-workflow",
    "lang": "all",
    "audience": "user",
    "title": "DOCX DFM Workflow",
    "blurb": "DOCX/DOC round trips, DFM editing, and validation.",
    "file": "site-content/docx-dfm-workflow.md",
    "titleByLang": {
      "zh": "DOCX / DFM 工作流"
    },
    "blurbByLang": {
      "zh": "DOCX/DOC round trip、DFM 編輯與驗證。"
    }
  },
  {
    "slug": "citation-provenance",
    "group": "citation-provenance",
    "lang": "all",
    "audience": "user",
    "title": "Citation Provenance",
    "blurb": "AssetRef, locator, hash, and evidence span rules.",
    "file": "site-content/citation-provenance.md",
    "titleByLang": {
      "zh": "引用與來源追溯"
    },
    "blurbByLang": {
      "zh": "AssetRef、locator、hash 與 evidence span 規則。"
    }
  },
  {
    "slug": "a2t-tables",
    ...
    "audience": "user",
    "title": "A2T Tables",
    "blurb": "TableContext design, citation cells, drafts, and rendering.",
    "file": "site-content/a2t-tables.md",
    "titleByLang": {
      "zh": "A2T 表格"
    },
    "blurbByLang": {
      "zh": "TableContext、cell citation、draft 與 rendering。"
    }
  },
  {
    ...
    "blurb": "LightRAG/Ollama/OpenAI knowledge graph setup and usage.",
    "file": "site-content/knowledge-graph.md",
    "titleByLang": {
      "zh": "知識圖譜"
    },
    "blurbByLang": {
      "zh": "LightRAG/Ollama/OpenAI knowledge graph 設定與使用。"
    }
  },
  {
    ...
    "blurb": "Async job lifecycle, progress, cancellation, and artifacts.",
    "file": "site-content/background-jobs.md",
    "titleByLang": {
      "zh": "背景工作"
    },
    "blurbByLang": {
      "zh": "Async job lifecycle、progress、cancel 與 artifacts。"
    }
  },
  {
    "slug": "etl-profiles",
    ...
    "audience": "user",
    "title": "ETL Profiles",
    "blurb": "Built-in and custom ETL profile behavior.",
    "file": "site-content/etl-profiles.md",
    "titleByLang": {
      "zh": "ETL Profiles"
    },
    "blurbByLang": {
      "zh": "內建與自訂 ETL profile 行為。"
    }
  },
  {
    ...
    "lang": "all",
    "audience": "start",
    "title": "VS Code Extension And MCP Setup",
    "blurb": "VSIX setup, MCP provider, and AI-client config merge.",
    "file": "site-content/vs-code-extension.md",
    "titleByLang": {
      "zh": "VS Code Extension 與 MCP 設定"
    },
    "blurbByLang": {
      "zh": "VSIX setup、MCP provider 與 AI-client config merge。"
    }
  },
  {
    "slug": "git-harness-hygiene",
    "group": "git-harness-hygiene",
    "lang": "all",
    "audience": "developer",
    "title": "Git Harness Hygiene",
    "blurb": "Local skip-worktree policy for VSIX-managed harness assets.",
    "file": "site-content/git-harness-hygiene.md",
    "titleByLang": {
      "zh": "Git Harness Hygiene"
    },
    "blurbByLang": {
      "zh": "VSIX-managed harness assets 的本機 skip-worktree policy。"
    }
  },
  {
    ...
    "blurb": "Implementation boundaries, tests, docs, and extension sync.",
    "file": "site-content/developer-guide.md",
    "titleByLang": {
      "zh": "開發者指南"
    },
    "blurbByLang": {
      "zh": "Implementation boundary、測試、文件與 extension sync。"
    }
  },
  {
    ...
    "lang": "all",
    "audience": "developer",
    "title": "Release And Testing",
    "blurb": "Release gates, focused tests, VSIX checks, and artifact audits.",
    "file": "site-content/release-testing.md",
    "titleByLang": {
      "zh": "Release 與測試"
    },
    "blurbByLang": {
      "zh": "Release gates、focused tests、VSIX checks 與 artifact audits。"
    }
  },
  {
    "slug": "code-map",
    ...
    "audience": "developer",
    "title": "Code Map",
    "blurb": "Where each major capability lives in the repository.",
    "file": "site-content/code-map.md",
    "titleByLang": {
      "zh": "程式碼地圖"
    },
    "blurbByLang": {
