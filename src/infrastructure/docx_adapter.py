...
from src.infrastructure.docx_openxml import (
    DOCX_LOCATOR_VERSION as _DOCX_LOCATOR_VERSION,
)
from src.infrastructure.docx_openxml import (
...
from src.infrastructure.docx_openxml import (
    emu_to_cm as _emu_to_cm,
)
from src.infrastructure.docx_openxml import (
    half_pt_to_pt as _half_pt_to_pt,
)
from src.infrastructure.docx_openxml import (
    safe_int as _safe_int,
)
from src.infrastructure.docx_openxml import (
    twips_to_cm as _twips_to_cm,
)
from src.infrastructure.docx_writeback import DocxWritebackMixin
from src.infrastructure.encoding_guard import validate_zip_magic

logger = logging.getLogger(__name__)


class DocxAdapter(DocxWritebackMixin):
    """
