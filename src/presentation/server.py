...
_section_service = SectionService(data_dir=settings.data_dir)
...
async def list_section_tree(
    ...
    """
    return await _section_service.list_section_tree(doc_id, max_depth, format)
...
async def get_section_detail(
    ...
    """
    return await _section_service.get_section_detail(doc_id, path)
...
async def get_section_blocks(
    ...
    """
    return await _section_service.get_section_blocks(
...
async def search_sections(
    ...
    Example:
        ...
        2. **Cardiogenic Shock**
           ...
           - Pages: 2980-2982
    """
    return await _section_service.search_sections(doc_id, query, fuzzy)
