"""Execute actual default-model Codex against only this checkout's native MCP tool."""
...
from tests.codex_table_create.scenario import prompt
...
def main():
    ...
    from tests.codex_table_create.audit import write_audit
