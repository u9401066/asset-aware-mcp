...
- **v0.9.0** (2026-07-09) — 混合 PDF/DOCX/DOC/ODT/ODS 批次自動攝入（單一 job + 逐檔進度回報 + 單檔故障隔離，公開工具數不變）、多引擎輸出來源溯源統一（`source_engine` 貫穿 manifest/figure-table/segmentation/citation-index）、Docling bbox 座標系正規化
