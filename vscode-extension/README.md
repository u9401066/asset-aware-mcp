...
- **DOCX Save Fidelity Hardening**: staged save, split-artifact sync, markdown table drift normalization, and safer complex table write-back are now part of `v0.6.4`
